<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventSponsors.aspx.cs" Inherits="SDPAdmin.Events.EventSponsors" %>
                        ...
                        <section class="scrollable padder">
                            <form id="form1" runat="server">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Name</label>
                                                                <asp:TextBox ID="SponsorsEventNameTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="SponsorsEventNameTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Date & Time</label>
                                                                <asp:TextBox ID="SponsorsEventDateTimeTextBox" runat="server" class="form-control"></asp:TextBox>
                                                            </div>
                                                        ...
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-4">
                                                                ...
                                                                <asp:FileUpload ID="SponsorsEventFileUpload" runat="server" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <label>
                                                                    &nbsp;
                                                                </label>
                                                                <asp:Button ID="SponsorsEventFileUploadButton" runat="server" Text="Upload File" CssClass="btn btn-danger form-control" OnClick="SponsorsEventFileUploadButton_Click" CausesValidation="False" />

                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Event Info</label>
                                                                <asp:TextBox CssClass="form-control" TextMode="MultiLine" Rows="2" ID="SponsorsEventInfoTextBox" runat="server"></asp:TextBox>
                                                                <asp:HiddenField ID="SponsorsEventFileName" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group pull-right">
                                                            <div class="col-sm-12">
                                                                <span id="SponsorsEventUpdatePanel" runat="server" visible="false">
                                                                    <asp:Button ID="SponsorsEventUpdateButton" runat="server" Text="Update" CssClass="btn btn-info" OnClick="SponsorsEventUpdateButton_Click" />
                                                                    <asp:Button ID="SponsorsEventUpdateCancelButton" runat="server" Text="Cancel Update" CssClass="btn btn-default" OnClick="SponsorsEventCancelButton_Click" CausesValidation="False" />

                                                                </span>
                                                                <asp:Button ID="SponsorsEventSaveButton" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="SponsorsEventSaveButton_Click" />
                                                                <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" OnClick="SponsorsEventCancelButton_Click" Visible="False" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </section>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <section class="panel panel-default scrollable">
                                                    <header class="panel-heading font-bold">Sponsor List</header>
                                                    <div class="panel-body">

                                                        <asp:GridView ID="SponsorsEventGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SponsorsEventSqlDataSource" CssClass="table table-striped m-b-none" Width="100%" AllowSorting="True" AllowPaging="True">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemStyle Width="15%" />
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink Target="_blank" ID="SponsorsEventAttachmentButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("EVENT_ATTACHMENT")%>' Text="" NavigateUrl='<%# Eval("EVENT_ATTACHMENT")%>'></asp:HyperLink>
                                                                        <asp:LinkButton ID="SponsorsEventEditButton" runat="server" CssClass="btn btn-primary fa fa-edit"
                                                                            CommandArgument='<%# Eval("ID")%>' Text="" OnClick="SponsorsEventEditButton_Click" CausesValidation="False"></asp:LinkButton>

                                                                        <asp:LinkButton ID="SponsorsEventDeleteButton" runat="server" CssClass="btn btn-danger fa fa-times"
                                                                            CommandArgument='<%# Eval("ID")%>'
                                                                            OnClientClick="return confirm('Do you want to delete?')"
                                                                            Text="" OnClick="SponsorsEventDeleteButton_Click" CausesValidation="False"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="SponsorsEventSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [EVENT_SPONSOR]"></asp:SqlDataSource>
                                    ...
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="SponsorsEventFileUploadButton" />
                                        <asp:AsyncPostBackTrigger ControlID="SponsorsEventSaveButton" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </form>
                        </section>
