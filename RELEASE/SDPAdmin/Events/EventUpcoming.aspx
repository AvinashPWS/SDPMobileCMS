<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventUpcoming.aspx.cs" Inherits="SDPAdmin.Events.EventUpcoming" %>
                        ...
                        <section class="scrollable padder">
                            <form id="form1" runat="server">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Name</label>
                                                                <asp:TextBox ID="UpcomingEventNameTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="UpcomingEventNameTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Date & Time</label>
                                                                <asp:TextBox ID="UpcomingEventDateTimeTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="UpcomingEventDateTimeTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>
                                                        ...
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-4">
                                                                ...
                                                                <asp:FileUpload ID="UpcomingEventFileUpload" runat="server" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <label>
                                                                    &nbsp;
                                                                </label>
                                                                <asp:Button ID="UpcomingEventFileUploadButton" runat="server" Text="Upload File" CssClass="btn btn-danger form-control" OnClick="UpcomingEventFileUploadButton_Click" CausesValidation="False" />

                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Event Info</label>
                                                                <asp:TextBox CssClass="form-control" TextMode="MultiLine" Rows="2" ID="UpcomingEventInfoTextBox" runat="server"></asp:TextBox>
                                                                <asp:HiddenField ID="UpcomingEventFileName" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group pull-right">
                                                            <div class="col-sm-12">
                                                                <span id="UpcomingEventUpdatePanel" runat="server" visible="false">
                                                                    <asp:Button ID="UpcomingEventUpdateButton" runat="server" Text="Update" CssClass="btn btn-info" OnClick="UpcomingEventUpdateButton_Click" />
                                                                    <asp:Button ID="UpcomingEventUpdateCancelButton" runat="server" Text="Cancel Update" CssClass="btn btn-default" OnClick="UpcomingEventCancelButton_Click" CausesValidation="False" />

                                                                </span>
                                                                <asp:Button ID="UpcomingEventSaveButton" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="UpcomingEventSaveButton_Click" />
                                                                <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" OnClick="UpcomingEventCancelButton_Click" CausesValidation="False" />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <section class="panel panel-default scrollable">
                                                    <header class="panel-heading font-bold">Upcoming Event List</header>
                                                    <div class="panel-body">

                                                        <asp:GridView ID="UpcomingEventGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="UpcomingEventSqlDataSource" CssClass="table table-striped m-b-none" Width="100%" AllowSorting="True" AllowPaging="True">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemStyle Width="15%" />
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink Target="_blank" ID="UpcomingEventAttachmentButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("EVENT_ATTACHMENT")%>' Text="" NavigateUrl='<%# Eval("EVENT_ATTACHMENT")%>'></asp:HyperLink>
                                                                        <asp:LinkButton ID="UpcomingEventEditButton" runat="server" CssClass="btn btn-primary fa fa-edit"
                                                                            CommandArgument='<%# Eval("ID")%>' Text="" OnClick="UpcomingEventEditButton_Click" CausesValidation="False"></asp:LinkButton>

                                                                        <asp:LinkButton ID="UpcomingEventDeleteButton" runat="server" CssClass="btn btn-danger fa fa-times"
                                                                            CommandArgument='<%# Eval("ID")%>'
                                                                            OnClientClick="return confirm('Do you want to delete?')"
                                                                            Text="" OnClick="UpcomingEventDeleteButton_Click" ClientIDMode="Inherit" CausesValidation="False"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="UpcomingEventSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [EVENT_UPCOMING]"></asp:SqlDataSource>
                                    ...
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="UpcomingEventFileUploadButton" />
                                        <asp:AsyncPostBackTrigger ControlID="UpcomingEventSaveButton" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </form>
                        </section>
