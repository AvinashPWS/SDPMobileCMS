<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventDaily.aspx.cs" Inherits="SDPAdmin.Events.EventDaily" %>
                        ...
                        <section class="scrollable padder">
                            <form id="form1" runat="server">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Name</label>
                                                                <asp:TextBox ID="DailyEventNameTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="DailyEventNameTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Date & Time</label>
                                                                <asp:TextBox ID="DailyEventDateTimeTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="DailyEventDateTimeTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>

                                                        </div>
                                                        <div class="form-group pull-in clearfix" style="display: none">
                                                            <div class="col-sm-4">
                                                                <label>
                                                                    Event Attachment</label>
                                                                <asp:FileUpload ID="DailyEventFileUpload" runat="server" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <label>
                                                                    &nbsp;
                                                                </label>
                                                                <asp:Button ID="DailyEventFileUploadButton" runat="server" Text="Upload File" CssClass="btn btn-danger form-control" OnClick="DailyEventFileUploadButton_Click" />
                                                                <asp:TextBox ID="DailyEventFileName" runat="server" Style="display: none"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" Enabled="false" ErrorMessage="Upload File" Font-Bold="True" ControlToValidate="DailyEventFileName" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>

                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Event Info</label>
                                                                <asp:TextBox CssClass="form-control" TextMode="MultiLine" Rows="2" ID="DailyEventInfoTextBox" runat="server"></asp:TextBox>
                                                                <%--<asp:HiddenField ID="DailyEventFileName" runat="server" />--%>
                                                            </div>
                                                        </div>
                                                        <div class="form-group pull-right">
                                                            <div class="col-sm-12">
                                                                <span id="DailyEventUpdatePanel" runat="server" visible="false">
                                                                    <asp:Button ID="DailyEventUpdateButton" runat="server" Text="Update" CssClass="btn btn-info" OnClick="DailyEventUpdateButton_Click" />
                                                                    <asp:Button ID="DailyEventUpdateCancelButton" runat="server" Text="Cancel Update" CssClass="btn btn-default" OnClick="DailyEventCancelButton_Click" CausesValidation="False" />

                                                                </span>
                                                                <asp:Button ID="DailyEventSaveButton" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="DailyEventSaveButton_Click" />
                                                                <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" OnClick="DailyEventCancelButton_Click" CausesValidation="False" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </section>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <section class="panel panel-default scrollable">
                                                    <header class="panel-heading font-bold">Daily Schedule List</header>
                                                    <div class="panel-body">

                                                        <asp:GridView ID="DailyEventGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="DailyEventSqlDataSource" CssClass="table table-striped m-b-none" Width="100%" AllowSorting="True" AllowPaging="True">
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="EVENT_INFO" HeaderText="Event Info" SortExpression="EVENT_INFO" Visible="False" />
                                                                <asp:BoundField DataField="DATETIME" HeaderText="Created On" SortExpression="DATETIME" />

                                                                <asp:TemplateField>
                                                                    <ItemStyle Width="15%" />
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink Target="_blank" ID="DailyEventAttachmentButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("EVENT_ATTACHMENT")%>' Text="" NavigateUrl='<%# Eval("EVENT_ATTACHMENT")%>' Visible="False"></asp:HyperLink>

                                                                        <asp:LinkButton ID="DailyEventEditButton" runat="server" CssClass="btn btn-primary fa fa-edit"
                                                                            CommandArgument='<%# Eval("ID")%>' Text="" OnClick="DailyEventEditButton_Click" CausesValidation="False"></asp:LinkButton>

                                                                        <asp:LinkButton ID="DailyEventDeleteButton" runat="server" CssClass="btn btn-danger fa fa-times"
                                                                            CommandArgument='<%# Eval("ID")%>'
                                                                            OnClientClick="return confirm('Do you want to delete?')"
                                                                            Text="" OnClick="DailyEventDeleteButton_Click" CausesValidation="False"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="DailyEventSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [EVENT_DAILY]"></asp:SqlDataSource>
                                    ...
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="DailyEventFileUploadButton" />
                                        <asp:AsyncPostBackTrigger ControlID="DailyEventSaveButton" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </form>
                        </section>
