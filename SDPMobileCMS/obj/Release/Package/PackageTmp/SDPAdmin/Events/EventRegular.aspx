<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventRegular.aspx.cs" Inherits="SDPAdmin.Events.EventRegular" %>
                        ...
                        <section class="scrollable padder">
                            <form id="form1" runat="server">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Name</label>
                                                                <asp:TextBox ID="RegularEventNameTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="RegularEventNameTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Date & Time</label>
                                                                <asp:TextBox ID="RegularEventDateTimeTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <%--<asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="RegularEventDateTimeTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                            </div>
                                                        ...
                                                        <div class="form-group pull-in clearfix" style="display: none">
                                                            <div class="col-sm-4">
                                                                ...
                                                                <asp:FileUpload ID="RegularEventFileUpload" runat="server" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <label>
                                                                    &nbsp;
                                                                </label>
                                                                <asp:Button ID="RegularEventFileUploadButton" runat="server" Text="Upload File" CssClass="btn btn-danger form-control" OnClick="RegularEventFileUploadButton_Click" CausesValidation="False" />

                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Event Info</label>
                                                                <asp:TextBox CssClass="form-control" TextMode="MultiLine" Rows="2" ID="RegularEventInfoTextBox" runat="server"></asp:TextBox>
                                                                <asp:HiddenField ID="RegularEventFileName" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group pull-right">
                                                            <div class="col-sm-12">
                                                                <span id="RegularEventUpdatePanel" runat="server" visible="false">
                                                                    <asp:Button ID="RegularEventUpdateButton" runat="server" Text="Update" CssClass="btn btn-info" OnClick="RegularEventUpdateButton_Click" />
                                                                    <asp:Button ID="RegularEventUpdateCancelButton" runat="server" Text="Cancel Update" CssClass="btn btn-default" OnClick="RegularEventCancelButton_Click" CausesValidation="False" />

                                                                </span>
                                                                <asp:Button ID="RegularEventSaveButton" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="RegularEventSaveButton_Click" />
                                                                <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" OnClick="RegularEventCancelButton_Click" CausesValidation="False" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </section>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <section class="panel panel-default scrollable">
                                                    <header class="panel-heading font-bold">Regular Schedule List</header>
                                                    <div class="panel-body">

                                                        <asp:GridView ID="RegularEventGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="RegularEventSqlDataSource" CssClass="table table-striped m-b-none" Width="100%" AllowSorting="True" AllowPaging="True">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <itemstyle width="15%" />
                                                                        <asp:HyperLink Target="_blank" ID="RegularEventAttachmentButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("EVENT_ATTACHMENT")%>' Text="" NavigateUrl='<%# Eval("EVENT_ATTACHMENT")%>' Visible="False"></asp:HyperLink>
                                                                        <asp:LinkButton ID="RegularEventEditButton" runat="server" CssClass="btn btn-primary fa fa-edit"
                                                                            CommandArgument='<%# Eval("ID")%>' Text="" OnClick="RegularEventEditButton_Click" CausesValidation="False"></asp:LinkButton>

                                                                        <asp:LinkButton ID="RegularEventDeleteButton" runat="server" CssClass="btn btn-danger fa fa-times"
                                                                            CommandArgument='<%# Eval("ID")%>'
                                                                            OnClientClick="return confirm('Do you want to delete?')"
                                                                            Text="" OnClick="RegularEventDeleteButton_Click" CausesValidation="False"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="RegularEventSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [EVENT_REGULAR]"></asp:SqlDataSource>
                                    ...
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="RegularEventFileUploadButton" />
                                        <asp:AsyncPostBackTrigger ControlID="RegularEventSaveButton" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </form>
                        </section>
