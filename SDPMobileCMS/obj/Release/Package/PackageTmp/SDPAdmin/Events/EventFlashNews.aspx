<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventFlashNews.aspx.cs" Inherits="SDPAdmin.Events.EventFlashNews" %>
                        ...
                        <section class="scrollable padder">
                            <form id="form1" runat="server">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Name</label>
                                                                <asp:TextBox ID="FlashNewsEventNameTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="FlashNewsEventNameTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>
                                                                    Event Date & Time</label>
                                                                <asp:TextBox ID="FlashNewsEventDateTimeTextBox" runat="server" class="form-control"></asp:TextBox>
                                                                <%--<asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="FlashNewsEventDateTimeTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                            </div>
                                                        ...
                                                        <div class="form-group pull-in clearfix">
                                                            <div class="col-sm-4">
                                                                ...
                                                                <asp:FileUpload ID="FlashNewsEventFileUpload" runat="server" CssClass="form-control" />
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <label>
                                                                    &nbsp;
                                                                </label>
                                                                <asp:Button ID="FlashNewsEventFileUploadButton" runat="server" Text="Upload File" CssClass="btn btn-danger form-control" OnClick="FlashNewsEventFileUploadButton_Click" CausesValidation="False" />

                                                            </div>
                                                            <div class="col-sm-6">
                                                                <label>Event Info</label>
                                                                <asp:TextBox CssClass="form-control" TextMode="MultiLine" Rows="2" ID="FlashNewsEventInfoTextBox" runat="server"></asp:TextBox>
                                                                <asp:HiddenField ID="FlashNewsEventFileName" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group pull-right">
                                                            <div class="col-sm-12">
                                                                <span id="FlashNewsEventUpdatePanel" runat="server" visible="false">
                                                                    <asp:Button ID="FlashNewsEventUpdateButton" runat="server" Text="Update" CssClass="btn btn-info" OnClick="FlashNewsEventUpdateButton_Click" />
                                                                    <asp:Button ID="FlashNewsEventUpdateCancelButton" runat="server" Text="Cancel Update" CssClass="btn btn-default" OnClick="FlashNewsEventCancelButton_Click" CausesValidation="False" />

                                                                </span>
                                                                <asp:Button ID="FlashNewsEventSaveButton" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="FlashNewsEventSaveButton_Click" />
                                                                <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" OnClick="FlashNewsEventCancelButton_Click" CausesValidation="False" />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <section class="panel panel-default scrollable">
                                                    <header class="panel-heading font-bold">Flash News List</header>
                                                    <div class="panel-body">

                                                        <asp:GridView ID="FlashNewsEventGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="FlashNewsEventSqlDataSource" CssClass="table table-striped m-b-none" Width="100%" AllowSorting="True" AllowPaging="True">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemStyle Width="15%" />
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink Target="_blank" ID="FlashNewsEventAttachmentButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("EVENT_ATTACHMENT")%>' Text="" NavigateUrl='<%# Eval("EVENT_ATTACHMENT")%>'></asp:HyperLink>
                                                                        <asp:LinkButton ID="FlashNewsEventEditButton" runat="server" CssClass="btn btn-primary fa fa-edit"
                                                                            CommandArgument='<%# Eval("ID")%>' Text="" OnClick="FlashNewsEventEditButton_Click" CausesValidation="False"></asp:LinkButton>

                                                                        <asp:LinkButton ID="FlashNewsEventDeleteButton" runat="server" CssClass="btn btn-danger fa fa-times"
                                                                            CommandArgument='<%# Eval("ID")%>'
                                                                            OnClientClick="return confirm('Do you want to delete?')"
                                                                            Text="" OnClick="FlashNewsEventDeleteButton_Click" CausesValidation="False"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="FlashNewsEventSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [EVENT_FLASH]"></asp:SqlDataSource>
                                    ...
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="FlashNewsEventFileUploadButton" />
                                        <asp:AsyncPostBackTrigger ControlID="FlashNewsEventSaveButton" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </form>
                        </section>
