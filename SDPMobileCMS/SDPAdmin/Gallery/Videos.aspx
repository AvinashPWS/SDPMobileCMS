<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Videos.aspx.cs" Inherits="SDPAdmin.Gallery.Videos" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                                ...
                                                <section class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <label>
                                                                            Video Header</label>
                                                                        <asp:TextBox ID="VideoHeaderNameTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="VideoHeaderNameTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <label>
                                                                            Video Title</label>
                                                                        <asp:TextBox ID="VideoTitleTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="VideoTitleTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <asp:TextBox runat="server" ID="VideoURLTextBox" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Font-Bold="True" ControlToValidate="VideoURLTextBox" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <asp:Button ID="VideoPreviewButton" runat="server" Text="Video Preview" CssClass="btn btn-primary" OnClick="VideoPreviewButton_Click" CausesValidation="False" />
                                                                <br />

                                                                <iframe id="VideoPlayer" width="500" height="300" runat="server" src=""></iframe>
                                                        ...
                                                        <div class="form-group pull-right">
                                                            <div class="col-sm-12">
                                                                <span id="VideoUpdatePanel" runat="server" visible="false">
                                                                    <asp:Button ID="VideoUpdateButton" runat="server" Text="Update" CssClass="btn btn-info" OnClick="VideoUpdateButton_Click" />
                                                                    <asp:Button ID="VideoUpdateCancelButton" runat="server" Text="Cancel Update" CssClass="btn btn-default" OnClick="VideoCancelButton_Click" CausesValidation="False" />
                                                                </span>
                                                                <asp:Button ID="VideoSaveButton" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="VideoSaveButton_Click" />
                                                                <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" OnClick="VideoCancelButton_Click" CausesValidation="False" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </section>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <section class="panel panel-default">
                                                    <header class="panel-heading font-bold">Video List</header>
                                                    <div class="panel-body">
                                                        <asp:GridView ID="VideoGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="VideoSqlDataSource" CssClass="table table-striped m-b-none" Width="100%" AllowSorting="True" AllowPaging="True">
                                                            <Columns>
                                                                <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" InsertVisible="False" ReadOnly="True" Visible="False" />
                                                                <asp:BoundField DataField="VIDEO_HEADER" HeaderText="Video Header" SortExpression="VIDEO_HEADER"  ItemStyle-Width="15%"/>
                                                                <asp:BoundField DataField="VIDEO_TITLE" HeaderText="Video Title" SortExpression="VIDEO_TITLE" />
                                                                <asp:BoundField DataField="DATETIME" HeaderText="Created On" SortExpression="DATETIME" />

                                                                <asp:TemplateField>
                                                                    <ItemStyle Width="25%" />
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink Target="_blank" ID="VideoAttachmentButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("VIDEO_URL")%>' Text="" NavigateUrl='<%# "http://www.youtube.com/embed/" + Eval("VIDEO_URL")%>'></asp:HyperLink>
                                                                        <asp:LinkButton ID="VideoEditButton" runat="server" CssClass="btn btn-primary fa fa-edit"
                                                                            CommandArgument='<%# Eval("ID")%>' Text="" OnClick="VideoEditButton_Click" CausesValidation="False"></asp:LinkButton>

                                                                        <asp:LinkButton ID="VideoDeleteButton" runat="server" CssClass="btn btn-danger fa fa-times"
                                                                            CommandArgument='<%# Eval("ID")%>'
                                                                            OnClientClick="return confirm('Do you want to delete?')"
                                                                            Text="" OnClick="VideoDeleteButton_Click" CausesValidation="False"></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="VideoSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [LIST_VIDEOS]"></asp:SqlDataSource>
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="VideoPreviewButton" />
                                        <asp:AsyncPostBackTrigger ControlID="VideoSaveButton" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </form>
                        </section>
