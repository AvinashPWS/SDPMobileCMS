<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SevaAnnadamMedia.aspx.cs" Inherits="SDPAdmin.Seva.SevaAnnadanamMedia" %>
                                            ...
                                            <div class="col-sm-12">
                                                <section class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                                ...
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink Target="_blank" ID="MediaFileNameButton" runat="server" CssClass="btn btn-info fa fa-external-link-square"
                                                                            CommandArgument='<%# Eval("MEDIA_ATTACHMENT")%>' Text="" NavigateUrl='<%# Eval("MEDIA_ATTACHMENT")%>'></asp:HyperLink>
                                                        ...
                                                        <asp:SqlDataSource ID="MediaSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SaiDatta %>" SelectCommand="SELECT * FROM [SEVA_ANNADANAM_MEDIA]"></asp:SqlDataSource>
