...
{
    public partial class SevaAnnadanamMedia : System.Web.UI.Page
    {
        ...
        protected void MediaSaveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Media.MEDIA_ATTACHMENT = Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["YouTubeURL"]) + MediaAttachmentTextbox.Text;
            }


            DBUtility DB = new DBUtility();

            if (DB.InsertMedia(Media, "SEVA_ANNADANAM_MEDIA"))
            {
        ...
        protected void MediaUpdateButton_Click(object sender, EventArgs e)
        {
            ...
            if (DB.UpdateMedia(Media, "SEVA_ANNADANAM_MEDIA"))
            {
                MediaCancelButton_Click(null, null);
                MediaGridView.DataBind();
            }
        ...
        {
            Response.Redirect("~/SDPAdmin/Seva/SevaAnnadamMedia.aspx");
        }
        ...
        protected void MediaEditButton_Click(object sender, EventArgs e)
        {
            ...
            SEVA_STHALA_MEDIA Media = DB.GetMedia(MediaEditButton.CommandArgument, "SEVA_ANNADANAM_MEDIA");
        ...
        protected void MediaDeleteButton_Click(object sender, EventArgs e)
        {
            ...
            if (DB.DeleteMedia(MediaDeleteButton.CommandArgument, "SEVA_ANNADANAM_MEDIA"))
            {
                MediaCancelButton_Click(null, null);
                MediaGridView.DataBind();
            }
